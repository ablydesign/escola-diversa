<div class="box more-diversity-item">
  <div class="box-inner">
    <div class="icone">
    ...
    <div class="link">
      <a data-src="<?= $attr['link']; ?>" href="javascript:void(0);" class="link-arrow ajax-more-diversity" title="Visualizar"><i class='bx bx-right-arrow-alt'></i></a>
    </div>
  </div>
</div>